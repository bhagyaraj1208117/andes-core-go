//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/bhagyaraj1208117/protobuf/protobuf  --gogoslick_out=$GOPATH/src block.proto
package block
...
import (
	...
	"github.com/bhagyaraj1208117/andes-core-go/data/headerVersionData"
)
