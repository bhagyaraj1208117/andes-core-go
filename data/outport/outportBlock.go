//go:generate protoc -I=. -I=$GOPATH/src/github.com/bhagyaraj1208117/andes-core-go/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/bhagyaraj1208117/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto
