...
```
//go:generate protoc -I=proto -I=$GOPATH/src -I=$GOPATH/src/github.com/bhagyaraj1208117/protobuf/protobuf  --gogoslick_out=. message.proto
```
...
Check [gogo protobuf geting started](https://github.com/bhagyaraj1208117/protobuf#getting-started) for initial setup.
